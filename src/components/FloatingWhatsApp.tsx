...
export function FloatingWhatsApp() {
  ...
  useEffect(() => {
    ...
    const syncVisibility = () => setVisible(!heroVisible && !contactVisible)
  ...
  return (
    <a
      ...
      href={buildWhatsAppUrl('Olá, Ferreira! Gostaria de conversar sobre um imóvel.')}
      target="_blank"
      rel="noreferrer"
      aria-label="Conversar com Ferreira pelo WhatsApp"
    >
      <span className="floating-whatsapp__signal" aria-hidden="true"><i /></span>
      <span className="floating-whatsapp__copy">
        <small>Atendimento direto · WhatsApp</small>
        <strong>Conversar com Ferreira</strong>
      </span>
