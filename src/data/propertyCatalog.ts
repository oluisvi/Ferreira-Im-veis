...
export const fallbackProperties: Property[] = [
  {
    ...
    mainImage: demoImages.casa,
    photos: [demoImages.casa, demoImages.interior],
    broker: 'Ferreira',
    creci: CRECI,
    whatsapp: WHATSAPP_NUMBER,
    status: 'Ativo',
    featured: true,
    features: ['Condomínio fechado', 'Área gourmet', 'Ambientes integrados'],
    palette: ['#D7C7B0', '#8A6A4A', '#2D2B27'],
    condominiumFee: 650,
    propertyTax: 1800,
    latitude: null,
    longitude: null,
  ...
  {
    code: 'FI-002',
    title: 'Apartamento com horizonte aberto',
    type: 'Apartamento',
    purpose: 'Venda',
    ...
    mainImage: demoImages.apartamento,
    photos: [demoImages.apartamento, demoImages.interior],
    broker: 'Ferreira',
    creci: CRECI,
    whatsapp: WHATSAPP_NUMBER,
    status: 'Ativo',
    featured: true,
    features: ['Varanda', '2 vagas', 'Vista aberta'],
    palette: ['#E6DED3', '#A88E74', '#393734'],
    condominiumFee: 780,
    propertyTax: 1250,
    latitude: null,
    longitude: null,
  ...
  {
    code: 'FI-003',
    title: 'Refúgio cercado por natureza',
    type: 'Refúgio',
    purpose: 'Venda',
    city: 'Jacareí',
    ...
    mainImage: demoImages.refugio,
    photos: [demoImages.refugio, demoImages.casa],
    broker: 'Ferreira',
    creci: CRECI,
    whatsapp: WHATSAPP_NUMBER,
    status: 'Ativo',
    featured: false,
    features: ['Área verde', 'Privacidade', 'Terreno amplo'],
    palette: ['#62705A', '#B69B72', '#E6E1D8'],
    condominiumFee: null,
    propertyTax: 2200,
    latitude: null,
    longitude: null,
...
export function filterProperties(properties: Property[], filters: PropertyFilters) {
  ...
  return properties.filter((property) => {
    const matchesSearch = !query || [property.code, property.title, property.city, property.neighborhood]
...
function isCatalogResponse(value: unknown): value is CatalogResponse {
  ...
  const record = value as Partial<CatalogResponse>
